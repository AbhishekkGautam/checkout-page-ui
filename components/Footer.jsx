  ...
  return (
    <section className="w-full mt-16 lg:mt-20">
      <div className="bg-black px-5 lg:px-0">
        ...
        <hr className="border-greyDivider mt-8 lg:mt-16" />
        <div className="container max-w-[1200px] mx-auto pt-8 pb-10 lg:py-8 flex flex-col-reverse gap-4 lg:flex-row lg:gap-3">
